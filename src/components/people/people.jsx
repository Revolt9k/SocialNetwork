            ...
            <div className={classes.col + " " + 'col-xs-10'}>
                {props.peopleList.map((user) => <div key={user.id}>
                    <div className={classes.container}>
                        <div>
                            <img className={classes.avaImg} src={user.photos.small != null ? user.photos.small : userDeafaultAva} alt=""/>
                            <div>
                                {user.followed ? <button className={classes.buttons + " " +  classes.unfollowButton} onClick={() => {
