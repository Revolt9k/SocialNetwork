...
const MyPosts = () => {
    return <container>
            ...
            <Post className={classes.item}message='what?' author='random boy'avaUrl='https://cs16planet.ru/steam-avatars/images/avatar3141.jpg'/>
            <Post className={classes.item}message='what?' author='random boy'avaUrl='https://cs16planet.ru/steam-avatars/images/avatar2672.jpg'/>
            <Post className={classes.item}message='what?' author='random boy'avaUrl='https://cs16planet.ru/steam-avatars/images/avatar449.jpg'/>
